...
var adaptUILayout = (function(){
    ...
    var adapt = function(uiWidth){
        ...
        //安卓版本，4.4以上不再支持target-densitydpi
        is_low_android_ver = ua.substr(ua.indexOf('android')+8,3) < 4.4;
        ...
        isScale          = deviceWidth > uiWidth * 2.4;

        initialScale     = isScale ? 1 : deviceWidth / uiWidth; 
        ...
        initialContent   = isiOS 
            ...
            : 
              (isWeiXin || is_low_android_ver) ?
               'target-densitydpi='+ targetDensitydpi +', width=device-width, user-scalable=no'
               :
               'target-densitydpi=device-dpi, initial-scale='+ initialScale +', width=device-width, user-scalable=no'
            ;
